...
import menuOpen from '../../../assets/img/icon-hamburger.svg'
...
function Nav() {
    ...
    let navClassName = condition ? `${s.toggleOpen}` : `${s.toggleClosed}`
    let logoClassName = condition ? `${s.logoToggleOpen}` : `${s.logoToggleClosed}`

    return (
        <>
            <div className={`${s.logo} ${logoClassName}`}>
            ...
            <nav className={navClassName}>
                <ul>
                    ...
                    <li className='btn btnRed'><Link to='/login'>Login</Link></li>
                    <li>
